...
| --- | --- | --- |
| Software | G1 | Unit and contract boundaries have automated evidence; real-browser E2E and axe accessibility checks are wired into CI, while sustained fuzzing, offline and rollback remain open. |
