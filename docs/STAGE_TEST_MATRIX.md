...
| --- | --- | --- |
| Software | G1 | Unit and contract boundaries have automated evidence; a real-browser E2E path is wired into CI, while sustained fuzzing, offline and rollback remain open. |
