...
| --- | --- | --- |
| Software | G1 | Unit, contract, snapshot/migration, bounded offline queue and release-manifest boundaries have automated evidence; real-browser E2E and axe accessibility checks are wired into CI, while sustained fuzzing and rollback remain open. |
